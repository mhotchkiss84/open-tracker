...
{
    public partial class LetsHopeSo : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProjectId = table.Column<int>(nullable: false),
                    UserId = table.Column<string>(nullable: false),
                    ProjectMemberId = table.Column<string>(nullable: false),
            ...
            migrationBuilder.CreateTable(
                name: "IssueAssignedMembers",
                columns: table => new
                {
                    Id = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    IssueId = table.Column<int>(nullable: false),
                    AssignedMemberId = table.Column<string>(nullable: false),
                    UserId = table.Column<string>(nullable: true),
                    IssuesIssueId = table.Column<int>(nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_IssueAssignedMembers", x => x.Id);
                    table.ForeignKey(
                        name: "FK_IssueAssignedMembers_AspNetUsers_AssignedMemberId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_IssueComments_Issues_IssuesIssueId",
                        column: x => x.IssuesIssueId,
                        principalTable: "Issues",
                        principalColumn: "IssueId",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_IssueAssignedMembers_AssignedMemberId",
                table: "IssueAssignedMembers",
                column: "AssignedMemberId");

            migrationBuilder.CreateIndex(
                name: "IX_IssueAssignedMembers_IssuesIssueId",
                table: "IssueAssignedMembers",
                column: "IssuesIssueId");

            migrationBuilder.CreateIndex(
                name: "IX_IssueComments_IssuesIssueId",
                table: "IssueComments",
                column: "IssuesIssueId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProjectMembers_ProjectsProjectId",
